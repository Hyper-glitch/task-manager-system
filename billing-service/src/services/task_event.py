...
class TaskEventService:
    ...
    def create_task(self, event: TaskCreatedEventSchema) -> None:
        ...
        if not task_cost:
            ...
            send_task_cost_added_event(task_cost=task_cost, task_public_id=task_dto.public_id)
    ...
    def assign_task(self, event: TaskAssignedEventSchema) -> None:
        ...
        with db.session.begin():
            ...
            user = self.user_repo.get_by_public_id(public_id=event.data.new_assignee_public_id)
    ...
    def complete_task(self, event: TaskCompletedEventSchema) -> None:
        ...
        if task_cost_added:
            send_task_cost_added_event(task_cost=task_cost, task_public_id=task.public_id)
